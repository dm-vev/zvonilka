...
const loginChallengeColumnList = `id, account_id, account_kind, purpose, code_hash, delivery_channel, targets, expires_at, created_at, used_at, used`
...
const accountCredentialColumnList = `account_id, kind, secret_hash, created_at, updated_at`
