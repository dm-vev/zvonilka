...
const privacyColumnList = `account_id, phone_visibility, last_seen_visibility, message_privacy, birthday_visibility, allow_contact_sync, allow_unknown_senders, allow_username_search, privacy_rules, show_read_date, created_at, updated_at`
