...
const (
	FederationBridgeService_PullBridgeFragments_FullMethodName        = "/zvonilka.federation.v1.FederationBridgeService/PullBridgeFragments"
	FederationBridgeService_SubmitBridgeFragments_FullMethodName      = "/zvonilka.federation.v1.FederationBridgeService/SubmitBridgeFragments"
	FederationBridgeService_AcknowledgeBridgeFragments_FullMethodName = "/zvonilka.federation.v1.FederationBridgeService/AcknowledgeBridgeFragments"
)

// FederationBridgeServiceClient is the client API for FederationBridgeService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type FederationBridgeServiceClient interface {
	PullBridgeFragments(ctx context.Context, in *PullBridgeFragmentsRequest, opts ...grpc.CallOption) (*PullBridgeFragmentsResponse, error)
	SubmitBridgeFragments(ctx context.Context, in *SubmitBridgeFragmentsRequest, opts ...grpc.CallOption) (*SubmitBridgeFragmentsResponse, error)
	AcknowledgeBridgeFragments(ctx context.Context, in *AcknowledgeBridgeFragmentsRequest, opts ...grpc.CallOption) (*AcknowledgeBridgeFragmentsResponse, error)
}

type federationBridgeServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewFederationBridgeServiceClient(cc grpc.ClientConnInterface) FederationBridgeServiceClient {
	return &federationBridgeServiceClient{cc}
}

func (c *federationBridgeServiceClient) PullBridgeFragments(ctx context.Context, in *PullBridgeFragmentsRequest, opts ...grpc.CallOption) (*PullBridgeFragmentsResponse, error) {
	out := new(PullBridgeFragmentsResponse)
	err := c.cc.Invoke(ctx, FederationBridgeService_PullBridgeFragments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *federationBridgeServiceClient) SubmitBridgeFragments(ctx context.Context, in *SubmitBridgeFragmentsRequest, opts ...grpc.CallOption) (*SubmitBridgeFragmentsResponse, error) {
	out := new(SubmitBridgeFragmentsResponse)
	err := c.cc.Invoke(ctx, FederationBridgeService_SubmitBridgeFragments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *federationBridgeServiceClient) AcknowledgeBridgeFragments(ctx context.Context, in *AcknowledgeBridgeFragmentsRequest, opts ...grpc.CallOption) (*AcknowledgeBridgeFragmentsResponse, error) {
	out := new(AcknowledgeBridgeFragmentsResponse)
	err := c.cc.Invoke(ctx, FederationBridgeService_AcknowledgeBridgeFragments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// FederationBridgeServiceServer is the server API for FederationBridgeService service.
// All implementations must embed UnimplementedFederationBridgeServiceServer
// for forward compatibility
type FederationBridgeServiceServer interface {
	PullBridgeFragments(context.Context, *PullBridgeFragmentsRequest) (*PullBridgeFragmentsResponse, error)
	SubmitBridgeFragments(context.Context, *SubmitBridgeFragmentsRequest) (*SubmitBridgeFragmentsResponse, error)
	AcknowledgeBridgeFragments(context.Context, *AcknowledgeBridgeFragmentsRequest) (*AcknowledgeBridgeFragmentsResponse, error)
	mustEmbedUnimplementedFederationBridgeServiceServer()
}

// UnimplementedFederationBridgeServiceServer must be embedded to have forward compatible implementations.
type UnimplementedFederationBridgeServiceServer struct {
}

func (UnimplementedFederationBridgeServiceServer) PullBridgeFragments(context.Context, *PullBridgeFragmentsRequest) (*PullBridgeFragmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PullBridgeFragments not implemented")
}
func (UnimplementedFederationBridgeServiceServer) SubmitBridgeFragments(context.Context, *SubmitBridgeFragmentsRequest) (*SubmitBridgeFragmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitBridgeFragments not implemented")
}
func (UnimplementedFederationBridgeServiceServer) AcknowledgeBridgeFragments(context.Context, *AcknowledgeBridgeFragmentsRequest) (*AcknowledgeBridgeFragmentsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AcknowledgeBridgeFragments not implemented")
}
func (UnimplementedFederationBridgeServiceServer) mustEmbedUnimplementedFederationBridgeServiceServer() {
}

// UnsafeFederationBridgeServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to FederationBridgeServiceServer will
// result in compilation errors.
type UnsafeFederationBridgeServiceServer interface {
	mustEmbedUnimplementedFederationBridgeServiceServer()
}

func RegisterFederationBridgeServiceServer(s grpc.ServiceRegistrar, srv FederationBridgeServiceServer) {
	s.RegisterService(&FederationBridgeService_ServiceDesc, srv)
}

func _FederationBridgeService_PullBridgeFragments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PullBridgeFragmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FederationBridgeServiceServer).PullBridgeFragments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FederationBridgeService_PullBridgeFragments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FederationBridgeServiceServer).PullBridgeFragments(ctx, req.(*PullBridgeFragmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FederationBridgeService_SubmitBridgeFragments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitBridgeFragmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FederationBridgeServiceServer).SubmitBridgeFragments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FederationBridgeService_SubmitBridgeFragments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FederationBridgeServiceServer).SubmitBridgeFragments(ctx, req.(*SubmitBridgeFragmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FederationBridgeService_AcknowledgeBridgeFragments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AcknowledgeBridgeFragmentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FederationBridgeServiceServer).AcknowledgeBridgeFragments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FederationBridgeService_AcknowledgeBridgeFragments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FederationBridgeServiceServer).AcknowledgeBridgeFragments(ctx, req.(*AcknowledgeBridgeFragmentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// FederationBridgeService_ServiceDesc is the grpc.ServiceDesc for FederationBridgeService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var FederationBridgeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "zvonilka.federation.v1.FederationBridgeService",
	HandlerType: (*FederationBridgeServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PullBridgeFragments",
			Handler:    _FederationBridgeService_PullBridgeFragments_Handler,
		},
		{
			MethodName: "SubmitBridgeFragments",
			Handler:    _FederationBridgeService_SubmitBridgeFragments_Handler,
		},
		{
			MethodName: "AcknowledgeBridgeFragments",
			Handler:    _FederationBridgeService_AcknowledgeBridgeFragments_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "contracts/federation/v1/federation.proto",
